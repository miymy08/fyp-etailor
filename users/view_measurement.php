...
?>
	...
	<tr><td><div id="pskbk"></div></td><td><input name="pesak_bawah" style="text-align:center;" value="<?php echo  number_format((float)$pesak_bawah, 1, '.', '');?>" readonly></td></tr>
