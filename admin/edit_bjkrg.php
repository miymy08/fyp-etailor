...
<form name ="songInfo" onsubmit="return confirm('Anda pasti dengan ukuran yang ingin dikemaskini ini?');" method="post" enctype="multipart/form-data" action="process_bjkrg.php">
<table align="center">
</table>
	...
	<tr><td>Kekek</td><td><input name="kekek" type="text" value="<?php echo  $row_medit['kekek'];?>" required></td></tr>
	<tr><td>Pesak Atas</td><td><input name="pesak_atas" type="text" value="<?php echo number_format((float)$row_medit['pesak_atas'], 1, '.', '');?>" readonly></td></tr>
	<tr><td>Pesak Bawah</td><td><input name="pesak_bwh" type="text" value="<?php echo  number_format((float)$row_medit['pesak_bwh'], 1, '.', '');?>" readonly></td></tr>
	<tr><td>Labuh Baju</td><td><input name="l_baju" type="text" value="<?php echo  $row_medit['l_baju'];?>" required></td></tr>
