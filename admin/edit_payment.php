...
<form name ="paymentInfo" onsubmit="return confirm('Anda pasti dengan maklumat pembayaran yang akan dikemaskini ini?');" method="post" enctype="multipart/form-data" action="epayment_process.php">
