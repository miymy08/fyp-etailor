...
<?php 
	if(isset($_GET['id_tailor'])){
		$tailor_edit = $_GET['id_tailor'];
		$t_edit = mysqli_query($conn,"SELECT * FROM tailor where id_tailor ='$tailor_edit'");
		
		$row_tedit = mysqli_fetch_array($t_edit);
...
<form name ="profileInfo" method="post" enctype="multipart/form-data" action="profile_process.php">
<table id="myTable"align="center" >
<input name="id_tailor" type="text" hidden value="<?php echo $row_tedit['id_tailor']; ?>">
<tr>
	<td id="info">Nama:</td><td><?php echo $_SESSION['f_tailor'];?></td>
</tr>
<tr>
	<td id="info">No. Telefon:</td><td><input class="w3-center" size="70" name="phone" type="text" value="<?php echo $row_tedit['phone_no'];?>"></td>
</tr>
