...
<div class="w3-top">
  <div class="w3-bar w3-special-blue w3-card">
    ...
    <a href="index.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">LAMAN UTAMA</a>
      ...
      <!--
	 <a href="view_profile.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">MY PROFILE</a>
	<div class="w3-dropdown-hover w3-hide-small">
     
    <button class="w3-padding-large w3-button" title="Customer">MEASUREMENT</button>     
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="view_measurement.php" class="w3-bar-item w3-button">VIEW MEASUREMENT</a>
        <a href="#" class="w3-bar-item w3-button">TEST FASHION</a>
       </div>
    </div>-->
    <div class="w3-dropdown-hover w3-hide-small">
