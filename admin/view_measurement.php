...
<h3><strong>Papar Ukuran</strong></h3>
...
<div  style='display:none;' id='kurung'>
	...
	<!--<img style="float:right;" src="images/baju kurung.jpg">	-->
<div class="row">

<div class="column">
    
<h4 ><strong>Baju Kurung</strong></h4>
<?php 
$m = "SELECT * FROM measurement where id_users ='$id_users'";
$query_m = mysqli_query($conn,$m);
$row_m = mysqli_fetch_array($query_m); ?>
<div class="table" align="center">
<form name="kurung" method="post" >
	<table  >
        <th><strong>Bahagian</strong></th><th><strong>Inci</strong></th>
        <tr><td><div id="bahuk"></div></td>
    <td><input name="bahu" style="text-align:center;" value="<?php echo  $row_m['bahu'];?>" readonly></td></tr>
        
	<tr><td><div id="dadak"></div></td><td><input name="dada" style="text-align:center;" value="<?php echo  $row_m['dada'];?>" readonly></td></tr>
        
	<tr><td><div id="ptgnk"></div></td><td><input name="l_tangan" style="text-align:center;" value="<?php echo  $row_m['l_tangan'];?>" readonly></td></tr>
        
	<tr><td><div id="glgk"></div></td><td><input name="lengan" style="text-align:center;" value="<?php echo  $row_m['lengan'];?>" readonly></td></tr>
        
	<tr><td><div id="kekekk"></div></td><td><input name="kekek" style="text-align:center;" value="<?php echo  $row_m['kekek'];?>" readonly></td></tr>
        
	<tr><td><div id="psktk"></div></td><td><input name="pesak_atas" style="text-align:center;" value="<?php echo number_format((float)$row_m['pesak_atas'], 1, '.', '');?>" readonly></td></tr>
        
	<tr><td><div id="pskbk"></div></td><td><input name="pesak_bawah" style="text-align:center;" value="<?php echo  number_format((float)$row_m['pesak_bwh'], 1, '.', '');?>" readonly></td></tr>
        
	<tr><td><div id="lbk"></div></td><td><input name="l_baju" style="text-align:center;" value="<?php echo  $row_m['l_baju'];?>" readonly></td></tr>
        
	<tr><td><div id="pingk"></div></td><td><input name="pinggang" style="text-align:center;" value="<?php echo  $row_m['pinggang'];?>" readonly></td></tr>
        
	<tr><td><div id="pggk"></div></td><td><input name="punggung" style="text-align:center;" value="<?php echo  $row_m['punggung'];?>" readonly></td></tr>
        
	<tr><td><div id="lkk"></div></td><td><input name="l_kain" style="text-align:center;" value="<?php echo  $row_m['l_kain'];?>" readonly></td></tr>
...
?>
	<?php $query = mysqli_query($conn, "SELECT * FROM fashion");
			$fashion_row = mysqli_fetch_array($query) 
			?>
</table>

<br>
<tr >
		<td><button class="w3-button w3-indigo w3-hover-light-blue"><a style="text-decoration: none;" onclick="return confirm('Adakah anda ingin mengemaskini ukuran bagi Baju Kurung?');" href="edit_bjkrg.php?id_users=<?php echo $row_c['id_users'] ?>">
             Kemaskini</a></button></td>
		<td><input class="w3-button w3-indigo w3-hover-light-blue" style="text-decoration: none;" type="submit" name="kurung" value="Teruskan" onclick="return confirm('Adakah anda pasti untuk memilih Baju Kurung dengan ukuran tersebut?');"></td>
...
if(isset($_POST['kurung'])){
	...
	$lengan = $_POST['lengan'];
	$kekek = $_POST['kekek'];
	$pesak_atas = $_POST['pesak_atas'];
	$pesak_bawah = $_POST['pesak_bawah'];
	$l_baju = $_POST['l_baju'];
	$pinggang = $_POST['pinggang'];
	$punggung = $_POST['punggung'];
	$l_kain = $_POST['l_kain'];
	$id_fashion = 1;
	$fashion_name = "Baju Kurung";
	$f_name = $row_c['f_name'];

	$_SESSION['id_users'] = $id_users;
	$_SESSION['f_name'] = $f_name;
	$_SESSION['id_fashion'] = $id_fashion;
	$_SESSION['fashion_name'] = $fashion_name;
	$_SESSION['bahu'] = $bahu;
	$_SESSION['dada'] = $dada;
	$_SESSION['l_tangan'] = $l_tangan;
	$_SESSION['lengan'] = $lengan;
    $_SESSION['kekek'] = $kekek;
	$_SESSION['l_baju'] = $l_baju;
	$_SESSION['pinggang'] = $pinggang;
	$_SESSION['punggung'] = $punggung;
	$_SESSION['l_kain'] = $l_kain;
...
?>
    ...
    <div class="column">
    <br><br><br><br>
    <img src="images/kurung.jpg" alt="Baju Kurung" style="width:90%">
    </div> 

	</div>
	<br>
	<p>Nilai Potongan Kain yang diperlukan ialah <b><?php echo number_format((float)$T_meter, 2, '.', ''); ?> Meters.(Bidang 45)</b></p>
	<p> Nilai ini merupakan nilai anggaran kain yang akan digunakan berdasarkan ukuran badan. Ukuran jarak potongan diantara setiap bahagian tidak termasuk dalam kiraan ini.</p>
...
<div class="column">
	<h4><strong>Baju Kurung Moden</strong></h4>
<?php 
$m = "SELECT * FROM measurement where id_users ='$id_users'";
$query_m = mysqli_query($conn,$m);
$row_m = mysqli_fetch_array($query_m)
?>
<div class="table">
<form name="moden" method="post" >
    
	<table  align="center">
	 <th><strong>Bahagian</strong></th><th><strong>Inci</strong></th>
<tr><td><div id="bahum"></div></td>
    
    <td><input name="bahu" style="text-align:center;" value="<?php echo  $row_m['bahu'];?>" readonly></td></tr>
        
	<tr><td><div id="dadam"></div></td><td><input name="dada" style="text-align:center;" value="<?php echo  $row_m['dada'];?>" readonly></td></tr>
        
	<tr><td><div id="ptgnm"></div></td><td><input name="l_tangan" style="text-align:center;" value="<?php echo  $row_m['l_tangan'];?>" readonly></td></tr>
        
	<tr><td><div id="glgm"></div></td><td><input name="lengan" style="text-align:center;" value="<?php echo  $row_m['lengan'];?>" readonly></td></tr>
        
	<tr><td><div id="lbm"></div></td><td><input name="l_baju" style="text-align:center;" value="<?php echo  $row_m['l_baju'];?>" readonly></td></tr>
        
	<tr><td><div id="pingm"></div></td><td><input name="pinggang" style="text-align:center;" value="<?php echo  $row_m['pinggang'];?>" readonly></td></tr>
        
	<tr><td><div id="pggm"></div></td><td><input name="punggung" style="text-align:center;" value="<?php echo  $row_m['punggung'];?>" readonly></td></tr>
        
	<tr><td><div id="lkm"></div></td><td><input name="l_kain" style="text-align:center;" value="<?php echo  $row_m['l_kain'];?>" readonly></td></tr>
<?php 
	$bahu = $row_m['bahu'];
	$dada = $row_m['dada'];
	$p_tgn = $row_m['l_tangan'];
...
?>
    ...
    <div>
	<tr>
		<td><button class="w3-button w3-indigo w3-hover-light-blue"><a style="text-decoration: none;" onclick="return confirm('Adakah anda ingin mengemaskini ukuran bagi Baju Kurung Moden?');" href="edit_moden.php?id_users=<?php echo $row_c['id_users'] ?>">
             Kemaskini</a></button></td>
		<td><input class="w3-button w3-indigo w3-hover-light-blue" style="text-decoration: none;" type="submit" name="moden" value="Teruskan" onclick="return confirm('Adakah anda pasti untuk memilih Baju Kurung Moden dengan ukuran tersebut?');"></td>
...
if(isset($_POST['moden'])){
	...
	$l_kain = $_POST['l_kain'];
	$id_fashion = 2;
	$fashion_name = "Baju Kurung Moden";
	$f_name = $row_c['f_name'];
...
<div class="row">
<div class="column">
	<h4><strong>Baju Kebaya</strong></h4>
<?php 
$m = "SELECT * FROM measurement where id_users ='$id_users'";
$query_m = mysqli_query($conn,$m);
$row_m = mysqli_fetch_array($query_m)
?>
<div class="table">
<form name="kebaya" method="post" >
	<table  align="center">
        <th><strong>Bahagian</strong></th><th><strong>Inci</strong></th>
	<tr><td><div id="bahub"></div></td>
    <td><input name="bahu" style="text-align:center;" value="<?php echo  $row_m['bahu'];?>" readonly></td></tr>
	<tr><td><div id="dadab"></div></td>
    <td><input name="dada" style="text-align:center;" value="<?php echo  $row_m['dada'];?>" readonly></td></tr>
	<tr><td><div id="ptgnb"></div></td>
    <td><input name="l_tangan" style="text-align:center;" value="<?php echo  $row_m['l_tangan'];?>" readonly></td></tr>
	<tr><td><div id="ldb"></div></td>
    <td><input name="l_depan"  style="text-align:center;"value="<?php echo  $row_m['l_depan'];?>" readonly></td></tr>
	<tr><td><div id="lbb"></div></td>
    <td><input name="l_belakang" style="text-align:center;" value="<?php echo  $row_m['l_belakang'];?>" readonly></td></tr>
	<tr><td><div id="glgb"></div></td>
    <td><input name="lengan" style="text-align:center;" value="<?php echo  $row_m['lengan'];?>" readonly></td></tr>
	<tr><td><div id="pingb"></div></td>
    <td><input name="pinggang" style="text-align:center;" value="<?php echo  $row_m['pinggang'];?>" readonly></td></tr>
	<tr><td><div id="pggb"></div></td>
    <td><input name="punggung" style="text-align:center;" value="<?php echo  $row_m['punggung'];?>" readonly></td></tr>
	<tr><td><div id="lkb"></div></td>
    <td><input name="l_kain" style="text-align:center;"value="<?php echo  $row_m['l_kain'];?>" readonly></td></tr>
...
//Bahagian baju
$B_baju = (($bahu*$l_depan+2)+($bahu*$l_belakang+2));
...
?>
		...
		<br>
	<tr>
		<td><button class="w3-button w3-indigo w3-hover-light-blue"><a style="text-decoration: none;" onclick="return confirm('Adakah anda ingin mengemaskini ukuran bagi Baju Kebaya?');" href="edit_kebaya.php?id_users=<?php echo $row_c['id_users'] ?>">
             Kemaskini</a></button></td>
		<td><input class="w3-button w3-indigo w3-hover-light-blue" style="text-decoration: none;" type="submit" name="kebaya" value="Teruskan" onclick="return confirm('Adakah anda pasti untuk memilih Baju Kebaya dengan ukuran tersebut?');"></td>


	</tr>
</form>
<?php
if(isset($_POST['kebaya'])){
	...
	$_SESSION['l_tangan'] = $l_tangan;
	$_SESSION['lengan'] = $lengan;
	$_SESSION['l_depan'] = $l_depan;
	$_SESSION['l_belakang'] = $l_belakang;
	$_SESSION['pinggang'] = $pinggang;
	$_SESSION['punggung'] = $punggung;
	$_SESSION['l_kain'] = $l_kain;
